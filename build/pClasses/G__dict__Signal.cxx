...
#define R__DICTIONARY_FILENAME G__dict__Signal
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::pSignal*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("pSignal", ::pSignal::Class_Version(), "pSignal.h", 43,
...
namespace {
  void TriggerDictionaryInitialization_libdict__Signal_Impl() {
...
#line 1 "libdict__Signal dictionary forward declarations' payload"
#pragma clang diagnostic ignored "-Wkeyword-compat"
#pragma clang diagnostic ignored "-Wignored-attributes"
#pragma clang diagnostic ignored "-Wreturn-type-c-linkage"
extern int __Cling_AutoLoading_Map;
class __attribute__((annotate("$clingAutoload$pSignal.h")))  pSignal;
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "libdict__Signal dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libdict__Signal",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libdict__Signal_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libdict__Signal_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libdict__Signal() {
  TriggerDictionaryInitialization_libdict__Signal_Impl();
}
